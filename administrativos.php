		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					<h1 class="mb-2 bread">Nuestro Personal Administrativo</h1>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container-fluid px-4">
			<div class="row">
					...
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch"
								style="background-image: url(images/alvaroadministrador.jpg);"></div>
						</div>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(images/verotransparencia.jpg);">
							</div>
						</div>
						<div class="text pt-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(images/lizfinanzas.jpg);">
							</div>
						</div>
						<div class="text pt-3 text-center">
							<h3>Lizeth Felix</h3>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(images/vianneycontabilidad.jpg);">
							</div>
						</div>
						<div class="text pt-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(images/estebanacademico.jpg);">
							</div>
						</div>
						<div class="text pt-3 text-center">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(images/jaquelin.jpg);">
							</div>
						</div>
						<div class="text pt-3 text-center">
							<h3>Jakelline Santos</h3>
							<span class="position mb-2">Control Escolar</span>
						</div>
					</div>
				</div>				
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(images/ricardocontrol.jpg);">
							</div>
						</div>
						<div class="text pt-3 text-center">
							<h3>Ricardo Pérez</h3>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url(images/evelynnps.jpg);">
							</div>
						</div>
						<div class="text pt-3 text-center">
