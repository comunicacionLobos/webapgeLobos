...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/portadaaumnos.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Alumnos</h1>
          </div>
        </div>
      </div>
    </section>
			...
			<div class="container">
				<div class="row d-flex">
					<div class="col-md-5 order-md-last wrap-about wrap-about d-flex align-items-stretch">
						<div class="img" style="background-image: url(images/familialobosalumnos.jpg);"></div>
					</div>
					<div class="col-md-7 wrap-about py-5 pr-md-4 ftco-animate">
          	<h2 class="mb-4">Nosotros siempre tenemos en cuenta a nuestros Alumnos</h2>
						<p>Ellos son el futuro de nuestro país y por ello tienen nuestro total apoyo.</p>
						<p>Reconocemos su esfuerzo de superarse día a día por sus metas, los apoyamos y les brindamos las herramientas necesarias hasta cumplir sus sueños</p>
					</div>
				</div>
			</div>
		</section>
    	...
    	<div class="container">
    		<div class="row justify-content-center mb-5 pb-2 d-flex">
    			<div class="col-md-6 align-items-stretch d-flex">
    				<div class="img img-video d-flex align-items-center">
    					<div class="video justify-content-center">
                <img src="images/reyescolosio.jpg" width="500px">
							</div>
    				</div>
    			</div>
          <div class="col-md-5 heading-section heading-section-white ftco-animate pl-lg-5 pt-md-0 pt-5">
            <h2 class="mb-4">Nuestros Reyes 2022 Plantel Colosio 🟠</h2>
            <h3>Vania Gabriela Flores Romero y López Ruiz Cristian Daniel</h3>
          </div>
        </div>	
    	</div>
    </section>
