...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/fondo edificios.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Nuestro Campus</h1>
          </div>
        </div>
      </div>
    </section>
			...
			<div class="container">
				<div class="row d-flex">
					<div class="col-md-5 order-md-last wrap-about wrap-about d-flex align-items-stretch">
						<div class="img" style="background-image: url(images/perfil.jpg);"></div>
					</div>
					<div class="col-md-7 wrap-about py-5 pr-md-4 ftco-animate">
          	<h2 class="mb-4">Preparatoria Municipal Omar Osvaldo Romo Covarrubias</h2>
						<p>La creación de la Preparatoria Municipal "Omar Osvaldo Romo Covarrubias" Tiene su fundamento en la demanda de la sociedad estudiantil, donde cientos de alumnos quedaban fuera de los institutos educativos cada semestre, por motivos académicos, económicos, migratorios, disciplinarios, entre otros.</p>
						<p>La preparatoria tiene un impacto fiel en la sociedad al subsanar y entender la encomienda dentro de la educación de bachiller en este Municipio brindando un espacio a todos aquellos jóvenes que quieren retomar sus estudios, apartando una educación integra, formada  por varios valores sociales, conocimiento teórico y competencias para su desarrollo en el ámbito laboral.</p>
					</div>
				</div>
			</div>
		</section>
    	...
    	<div class="container">
    		<div class="row justify-content-center mb-5 pb-2 d-flex">
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/81q7cDIQ-Ck" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							</div>
    				</div>
    			</div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4">Lo que nuestros estudiantes opinan</h2>
            <p>Somos una institución que aporta a la juventud una educación integral, formada por valores sociales que contribuyen a su desarrollo académico. #FamiliaLobos</p>
          </div>
        </div>
    	...
    	<div class="container">
    		<div class="row justify-content-center mb-5 pb-2 d-flex">
    			<div class="col-md-6 align-items-stretch d-flex">
    				<div class="img img-video d-flex align-items-center">
    					<div class="video justify-content-center">
              <iframe width="600" height="315" src="https://www.youtube.com/embed/BqWfnx_QkzQ" title="Escuela Segura" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>							</div>
    				</div>
    			</div>
          <div class="col-md-6 heading-section heading-section-white ftco-animate pl-lg-5 pt-md-0 pt-5">
            <h2 class="mb-4">Somos una escuela segura</h2>
